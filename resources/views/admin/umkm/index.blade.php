...
<style>
    ...
    @media (max-width: 768px) {
        ...
        .table tbody td:nth-child(1):before { content: "Nama Toko: "; }
        .table tbody td:nth-child(2):before { content: "Deskripsi: "; }
        .table tbody td:nth-child(3):before { content: "Alamat: "; }
        .table tbody td:nth-child(4):before { content: "No Telp: "; }
        .table tbody td:nth-child(5):before { content: "Logo: "; }
    }
                ...
                <table class="table table-bordered table-hover mb-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td data-label="Logo">
                                @if($umkm->logo)
                                    <img src="{{ asset('storage/' . $umkm->logo) }}" width="50" height="50" alt="Logo" style="object-fit: cover;">
                                @else
                            ...
                            <td data-label="Aksi">
                                <div class="d-flex flex-wrap justify-content-center">
                                    <a href="{{ route('admin.umkm.show', $umkm->id) }}" class="btn btn-info btn-sm mb-1">
                                        <i class="bi bi-eye me-1"></i>Detail
                                    </a>
                                    <a href="{{ route('admin.umkm.products', $umkm->id) }}" class="btn btn-primary btn-sm mb-1">
                ...
                <table class="table table-bordered table-hover mb-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td data-label="Aksi">
                                <div class="d-flex flex-wrap justify-content-center">
                                    <form action="{{ route('admin.umkm.approve', $umkm->id) }}" method="POST" class="d-inline-block mb-1">
                                        @csrf
                                        <button class="btn btn-success btn-sm" type="submit">
                                            <i class="bi bi-check-lg me-1"></i>Approve
                                        </button>
                                    </form>
                                    <form action="{{ route('admin.umkm.reject', $umkm->id) }}" method="POST" class="d-inline-block mb-1">
                                        @csrf
