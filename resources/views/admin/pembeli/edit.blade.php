...
@section('title')
    <i class="fas fa-user-edit me-2"></i> Edit Akun Pembeli
@endsection
                ...
                <div class="row align-items-center">
                    <div class="col-lg-8">
                        <div class="hero-content">
                            ...
                            <p class="mb-3">Perbarui informasi akun pembeli UMKM Indramayu</p>
                            <div class="d-flex flex-wrap gap-3 align-items-center">
                                <span class="badge bg-gold text-dark fs-6 px-3 py-2">
                                    <i class="fas fa-edit me-2"></i>Form Edit
                                </span>
                                <span class="text-gold"><i class="fas fa-user me-2"></i>{{ $pembeli->name }}</span>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-8">
                    <div class="form-card">
                        <div class="form-header">
                            <h3><i class="fas fa-user-cog me-2"></i>Form Edit Pembeli</h3>
                            <p class="mb-0">Perbarui data akun pembeli</p>
                        </div>
                        <div class="form-body">
                            <form action="{{ route('admin.pembeli.update', $pembeli->id) }}" method="POST">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="info-item">
                                                    ...
                                                    <p class="info-value">{{ $pembeli->created_at->format('d F Y') }}</p>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="info-item">
                                                    <label>Terakhir Diperbarui</label>
                                                    <p class="info-value">{{ $pembeli->updated_at->format('d F Y') }}</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="form-section">
                                    <h5 class="section-title">
                                        <i class="fas fa-chart-bar me-2"></i>Statistik Pembeli
                                    </h5>
                                    <div class="stats-grid">
                                        <div class="stat-item">
                                            <i class="fas fa-shopping-bag stat-icon"></i>
                                            <div class="stat-info">
                                                <span class="stat-number">{{ $pembeli->orders->count() }}</span>
                                        ...
                                        <div class="stat-item">
                                            ...
                                            <div class="stat-info">
                                                <span class="stat-number">
                                                    @if($pembeli->orders->count() > 0)
                                                        {{ $pembeli->orders->last()->created_at->diffForHumans() }}
                                                    @else
                                                        -
                                                    @endif
                                                </span>
                                ...
                                <div class="form-actions">
                                    ...
                                    <a href="{{ route('admin.pembeli.index') }}" class="btn btn-cancel">
